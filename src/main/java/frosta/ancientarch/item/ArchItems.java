...
public class ArchItems {
    ...
    public static final Item PURIFIED_WINTER = registerItem("purified_winter", new PurifiedWinterItem(ArchToolMaterial.HOLY,10,-3.3f,new FabricItemSettings().fireproof().rarity(Rarity.RARE)));
